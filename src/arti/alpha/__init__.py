"""Explicit alpha APIs that are ready for controlled experimentation.
...
from ..recursive_context_compiler import (
    ...
    TokenPositionEncoder,
)
from ..rcc_host import RCCHostAdapter, RCCHostResult
from ..federal_compiler import (
...
from ..recursive_language import RecursiveLanguageModel, prefix_plan
...
# The alpha namespace gives the reversible operations their intended concise
# names without changing the published arti.nn Fold@1 / UnFold@1 surface.
Fold = TopologyFold
