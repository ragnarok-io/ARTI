...
The complete runnable example is [RCC host adapter](../examples/rcc_host_adapter.py).
...
`arti/recursive-context-compiler@1` is the RCC compiler implementation and
`arti/recursive-language@1` is its language-model artifact schema.
